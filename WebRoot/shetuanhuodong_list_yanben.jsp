				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">社团活动列表</td>
						</tr>
					</table>
				</td>
			</tr>
						...
						<tr align="left" >
							<td colspan="17">
								<form action="shetuanhuodongList.do" name="myform" method="post">
									查询   活动名称：<input name="huodongmingcheng" type="text" id="huodongmingcheng" class="form-control2" />  活动时间：<input name="huodongshijian1" type="text" id="huodongshijian1"  value='' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" class="form-control2" />-<input name="huodongshijian2" type="text" id="huodongshijian2"  value='' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" class="form-control2" />
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.huodongmingcheng}</td>    <td>${u.huodongshijian}</td>    <td>${u.shetuanbianhao}</td>    <td>${u.shetuanmingcheng}</td>        <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=shetuanhuodong'"/></td>
                              ...
                              <td align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="sthdDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
