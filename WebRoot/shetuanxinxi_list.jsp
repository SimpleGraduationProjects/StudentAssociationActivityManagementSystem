			...
			<td>
				<table width="100%" border="0" align="center" cellpadding="4"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td height="30" colspan="17" background="images/table_header.gif">社团信息列表</td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td bgcolor="#FFFFFF">
								...
								<tr align="left">
									<td colspan="17">
										<form action="shetuanxinxiList.do" name="myform" method="post">
											查询 社团编号：<input name="shetuanbianhao" type="text"
												id="shetuanbianhao" class="form-control2" /> 社团名称：<input
												name="shetuanmingcheng" type="text" id="shetuanmingcheng"
												class="form-control2" /> 社团等级：<input name="shetuandengji"
												type="text" id="shetuandengji" class="form-control2" /> <input
												type="submit" value="查询" class="btn btn-info btn-small" />
										</form>
									</td>
								</tr>
							</table>
				...
				%>
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td>${u.fuzeren}</td>
										<td width='90' align='center' bgcolor='#ebf0f7'><a
											href='${u.shetuanLOGO}' target='_blank'><img
												src='${u.shetuanLOGO}' width=88 height=99 border=0 /></a></td>
										...
										<td align="center"><a class="btn btn-info btn-small"
											href="doUpdateShetuanxinxi.do?id=${u.id }">编辑</a> <a
											class="btn btn-info btn-small"
											href="deleteShetuanxinxi.do?id=${u.id }"
											onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
											<a class="btn btn-info btn-small"
											href="stxxDetail.do?id=${u.id}" target="_blank">详细</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="shetuanxinxiList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="shetuanxinxiList.do?page=${page.page+1 }">下一页</a>
				<a href="shetuanxinxiList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
