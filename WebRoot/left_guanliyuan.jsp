...
<dl class="custom">
			...
			<dd><a href="xinwentongzhi_add.jsp?lb=校内新闻" target="hsgmain">校内新闻添加</a></dd><dd><a href="xinwentongzhiList.do?lb=校内新闻" target="hsgmain">校内新闻查询</a></dd>
		</dl><dl class="custom">
			...
			<dd><a href="liuyanbanList.do" target="hsgmain">留言管理</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">学生管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xueshengxinxiList.do" target="hsgmain">学生查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">退团申请管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="tuituanshenqingList.do" target="hsgmain">退团申请查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">申请入团管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="shenqingrutuanList.do" target="hsgmain">申请入团查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">社团管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="shetuanxinxi_add.jsp" target="hsgmain">社团添加</a></dd><dd><a href="shetuanxinxiList.do" target="hsgmain">社团查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">社团活动管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="shetuanhuodongList.do" target="hsgmain">社团活动查询</a></dd>
		</dl>
