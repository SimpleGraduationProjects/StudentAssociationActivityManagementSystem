...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">申请入团列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shetuanbianhao}</td>    <td>${u.shetuanmingcheng}</td>    <td>${u.xuehao}</td>    <td>${u.xingming}</td>    <td>${u.yuanxi}</td>    <td>${u.banji}</td>    <td>${u.dianhua}</td>        <td align='center'>${u.issh} </td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateShenqingrutuan.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteShenqingrutuan.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="shenqingrutuanDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shenqingrutuanList2.do?page=1" >首页</a>
             <a href="shenqingrutuanList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shenqingrutuanList2.do?page=${page.page+1 }">下一页</a>
			<a href="shenqingrutuanList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
