...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">回复内容：</td><td><textarea name='huifuneirong' cols='50' rows='5' id='huifuneirong' onblur='' class="form-control" style="width:600px; height:80px;" ></textarea></td></tr>
