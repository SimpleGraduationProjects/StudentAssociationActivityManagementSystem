...
<dl class="custom">
			...
			<dd><a href="doUpdateShetuanxinxi2.do" target="hsgmain">修改个人资料</a></dd>
		</dl><dl class="custom">
			...
			<dd><a href="shenqingrutuanList3.do" target="hsgmain">申请入团查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">申请入团管理<img src="images/left/select_xl01.png"></dt>
			...
			<dd><a href="shetuanhuodong_add.jsp" target="hsgmain">社团活动添加</a></dd><dd><a href="shetuanhuodongList2.do" target="hsgmain">社团活动查询</a></dd>
		</dl>
