...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">退团申请列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="tuituanshenqingList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shetuanbianhao}</td>    <td>${u.shetuanmingcheng}</td>    <td>${u.xuehao}</td>    <td>${u.xingming}</td>    <td>${u.yuanxi}</td>    <td>${u.tuituanliyou}</td>    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=tuituanshenqing'"/></td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateTuituanshenqing.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteTuituanshenqing.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="tuituanshenqingList.do?page=1" >首页</a>
             <a href="tuituanshenqingList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="tuituanshenqingList.do?page=${page.page+1 }">下一页</a>
			<a href="tuituanshenqingList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
