...
function gows()
{
	document.location.href="tuanweilaoshi_add.jsp?id=<%=id%>";
}
	...
	<body>
			<form action="updateTuanweilaoshi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.bianhao.value='${tuanweilaoshi.bianhao}';</script>	<script language="javascript">document.form1.mima.value='${tuanweilaoshi.mima}';</script>	<script language="javascript">document.form1.xingming.value='${tuanweilaoshi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${tuanweilaoshi.xingbie}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${tuanweilaoshi.lianxidianhua}';</script>	<script language="javascript">document.form1.jianjie.value='${tuanweilaoshi.jianjie}';</script>	
					 </table>
			</form>
   </body>
</html>
